...
export function buildVolumesHostconfig(projectName: string, volumes, output, type) {
...
export function buildEnvVarsFromFile(env_file_path: fs.PathOrFileDescriptor, output: ContainerCreateOptions['Env']) {
