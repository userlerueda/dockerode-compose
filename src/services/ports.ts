...
export function addServicePorts(service: DockerComposeService, opts: Dockerode.ContainerCreateOptions): void {
      ...
      if (typeof port === 'object') {
        ...
        if (port_split.length == 2) {
          ...
          if (port_split[1].includes('-')) {
            ...
            let split_port_split0_array: number[] = [];
            ...
            let split_port_split1_array: number[] = [];
            ...
            for (let i = parseInt(split_port_split[0]); i <= parseInt(split_port_split[1]); i++) {
          ...
          if (port_split[2].includes('-')) {
            ...
            let split_port_split2_array: number[] = [];
